...
const TireConfig = ({ onClose, modal }) => {
  ...
  return (
    <div ref={searchPageContentArea} className="tireConfiguration">
      <div className="tireConfigurationHeader bg-white p-10 w-full h-full absolute top-0 right-0 md:w-1/3">
        ...
        <div className="configModalContent mt-10">
          <div className="configModalTitle border-b-[1px] border-gray-400 font-semibold uppercase text-black text-sm md:text-lg">
            <h4>COnfigure os pneus para o seu ve!</h4>
          </div>
        </div>
      </div>
    </div>
